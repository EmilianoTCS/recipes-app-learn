      ...
      <div className="bg-cream rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex flex-wrap gap-2 mb-4">
            <span className="px-2 py-1 bg-earth-hard text-cream rounded-full text-sm">{meal.strCategory}</span>
            <span className="px-2 py-1 bg-earth-hard text-cream rounded-full text-sm">{meal.strArea}</span>
            {meal.strTags &&
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-xl text-gray-700 font-semibold mb-4 border-b pb-2">Ingredientes</h2>
              ...
              {meal.strYoutube && (
                <div className="mt-8">
                  <h2 className="text-xl font-semibold mb-4 border-b pb-2 text-gray-700">Video tutorial</h2>
                  <a
            ...
            <div>
              <h2 className="text-xl font-semibold mb-4 border-b pb-2 text-gray-700">Preparación</h2>
